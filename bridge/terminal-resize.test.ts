...
describe("resizeTerminal", () => {
  test("finds Herdr in the operator home when a supervisor PATH cannot", () => {
    const found = resolveHerdrBin(
      { HOME: "/home/operator", PATH: "/usr/bin:/bin" },
      (path) => path === "/home/operator/.local/bin/herdr",
    );
    expect(found).toBe("/home/operator/.local/bin/herdr");
  });
