...
- Codex replies containing blank paragraph rows are verified and submitted instead of stranded (c2e6b12)
...
- Display settings can fit the current pane's real PTY to the remote device viewport on demand (a0732a5)

## [0.38.1] - 2026-08-30

### Fixed

- Pane tabs stay integrated in the title bar at every viewport width (c891b08)

## [0.38.0] - 2026-08-30

### Changed

- Mobile pane tabs move into the title bar with a compact switcher and new-tab action (9a0159a)

## [0.37.1] - 2026-08-30

### Fixed

- Codex completion rules stay on one clipped row instead of wrapping into extra separators (609dd7f)

## [0.37.0] - 2026-08-29

### Added

- Images can be dragged onto the composer to upload and attach their host path (833d1d2)

## [0.36.1] - 2026-08-29

### Fixed

- Integrated upstream 0.36.0 while preserving multiline replies and local full-width terminal rendering (313ed5d, d680130)
...
- Composer text now uses the field's full width while Attach and Send occupy a bottom action shelf (4ac8c74)
...
- Narrow terminal grids now expand to use spare mirror width without shrinking the chosen text size (4f2483d)
